                    ...
                    <main className="flex-grow flex flex-col bg-white">
                        <div className="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="flex-shrink-0 my-auto py-16 sm:py-32">
                                <p className="text-sm font-semibold text-indigo-600 uppercase tracking-wide">Payment successful</p>
                                <h1 className="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                                    Thank you
                                </h1>
                                <p className="mt-2 text-base text-gray-500">We received your payment,</p>
                                <p className="mt-1 text-base">You'll get notified when it is on the way.</p>
                                <div className="mt-6">
